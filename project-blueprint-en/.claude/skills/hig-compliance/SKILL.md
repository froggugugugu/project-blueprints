...
[references/ui-glossary-template.md](references/ui-glossary-template.md).

---

### Phase 2: HIG Compliance Check (8 Categories)

Scan the 8 categories defined in [references/hig-check-categories.md](references/hig-check-categories.md)

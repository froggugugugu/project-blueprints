...
Strictly follow the `AGENTS.md` (shared rules) and `CLAUDE.md` policies. For project-specific design conventions, refer to the "Design System" section in [docs/development-patterns.md](../../../docs/development-patterns.md).
...
are in [references/system-audit-workflow.md](references/system-audit-workflow.md).
...
The skeleton is in the "Report Format (Review Mode)" section of [references/report-templates.md](references/report-templates.md). Read it when needed and copy it as is.

## Report Format (System Consistency Audit Mode)

The skeleton is in the "Report Format (System Consistency Audit Mode)" section of [references/report-templates.md](references/report-templates.md). Read it when needed and copy it as is.
